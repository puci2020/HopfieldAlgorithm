...
namespace DMU.Math
{
    public class Matrix
    {
        ...
        public Matrix(double[] array)
        {
            ...
            if (cols < 1)
                throw new ArgumentException(AIF.Resources.ErrorMessages.ArgumentColumnLength);
        ...
        public Matrix(double[] array, bool columnMatrix)
        {
            ...
            if (columnMatrix)
            {
                rows = array.Length;
                if (rows < 1)
                    throw new ArgumentException(AIF.Resources.ErrorMessages.ArgumentRowLength);
            }
            else
            {
                cols = array.Length;
        ...
        public Matrix(double[,] array)
       {
        ...
        public Matrix(double[] array, int rows, int cols)
        {
            ...
            {
                throw new ArgumentException(AIF.Resources.ErrorMessages.ArgumentVectorNotValid);
            }
        ...
        public Matrix(int diagonalMatrixSize, double diagonalValue)
        {
            ...
            if (diagonalMatrixSize < 1)
                throw new ArgumentException(AIF.Resources.ErrorMessages.ArgumentSizeZero);
        ...
        public double VectorLength
        {
            ...
            {
                if (!this.IsVector)
                    throw new NotSupportedException(AIF.Resources.ErrorMessages.ArgumentMatrixIsNotVector);
        ...
        public Matrix GetRows(int startRow, int endRow)
        {
            ...
            //validate arguments
            if (startRow >= endRow)
                throw new ArgumentException(AIF.Resources.ErrorMessages.ArgumentStartRowGreaterThanEndRow);
            if (startRow >= this.RowCount || endRow >= this.RowCount || startRow < 0 || endRow < 0)
                throw new ArgumentException(AIF.Resources.ErrorMessages.ArgumentInvalidRow);
        ...
        public Matrix GetColumns(int startColumn, int endColumn)
        {
            ...
            if (startColumn >= endColumn)
                throw new ArgumentException(AIF.Resources.ErrorMessages.ArgumentStartColumnGreaterThanEndRow);
            if (startColumn >= this.ColumnCount || endColumn >= this.ColumnCount || startColumn < 0 || endColumn < 0)
                throw new ArgumentException(AIF.Resources.ErrorMessages.ArgumentInvalidColumn);
        ...
        public static Matrix Add(Matrix matrix1, Matrix matrix2)
        {
            ...
            if (matrix1.RowCount != matrix2.RowCount || matrix1.ColumnCount != matrix2.ColumnCount)
                throw new ArgumentException(AIF.Resources.ErrorMessages.ArgumentMatricesIncompatible);
